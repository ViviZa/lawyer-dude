  ...
  render() {
    return (
      <Router history={history}>
          ...
          <Route exact path="/jailgame1" component={() => <JailGameOne ID={105} cssGameClass="pagecontent" cssLaywerClass="jailpagecontent" showNavigation={true}/>}/>
          <Route exact path="/jailgame2" component={() => <JailGameTwo ID={106} cssGameClass="pagecontent" cssLaywerClass="jailpagecontent" showNavigation={true}/>}/>
